...
**Documenter** — One of the three primary user types. A Documenter primarily wants easy voice-based maintenance logging without the social aspects.
...
**Session** — A single logged work event on a vehicle. A session has a timestamp, a voice recording or transcript, extracted parts/costs/time, and manual notes.

**Sharer** — One of the three primary user types. A Sharer primarily wants to publish their build for community and social media audiences.
