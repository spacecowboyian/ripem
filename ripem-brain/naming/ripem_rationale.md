...
### 4. Action-Oriented
The name implies doing — it's a verb. It's not passive. It suits an app about actively building and documenting.

### 5. Memorable and Distinctive
It's not a generic compound noun (BuildLog, CarTrack, etc.). It stands out in App Store search and in conversation.
...
- [naming_exploration.md](./naming_exploration.md)
